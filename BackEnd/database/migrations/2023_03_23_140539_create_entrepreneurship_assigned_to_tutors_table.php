...
class CreateEntrepreneurshipAssignedToTutorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entrepreneurship_assigned_to_tutors', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('entrepreneurship_assigned_to_tutors');
    }
}
