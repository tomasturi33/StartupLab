...
class EntrepreneurshipWindowsController extends Controller
{
    ...
    {
        $windows = EntrepreneurshipWindow::select('id','title', 'logo', 'edition_id', 'published', 'state')
     ...
     * @return \Illuminate\Http\Response
     */
    public function show($edition_id, $entrepreneurship_id)
    {
        $window = EntrepreneurshipWindow::find($entrepreneurship_id);
