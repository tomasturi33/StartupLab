...
<script>
  ...
  import infoModule from '@/components/tutor/pill/infoModule.vue'
  import contentModule from '@/components/tutor/pill/contentModule.vue'
  import taskModule from '@/components/tutor/pill/taskModule.vue'
