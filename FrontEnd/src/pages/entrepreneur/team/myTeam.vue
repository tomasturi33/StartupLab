...
<script>
  ...
  import responsibleProfile from '@/components/entrepreneur/team/responsibleProfile.vue'
  import noResponsibleProfile from '@/components/entrepreneur/team/noResponsibleProfile.vue'
