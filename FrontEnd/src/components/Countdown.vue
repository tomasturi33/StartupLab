<template>
  <div class="countdown mt-4">
    <div v-if="days" class="countdown__block">
      <div class="countdown__digit font-weight-light">{{ days | twoDigits }}</div>
      <div class="countdown__text">Días</div>
    </div>
    <div class="countdown__block">
      <div class="countdown__digit font-weight-light">{{ hours | twoDigits }}</div>
      <div class="countdown__text">Horas</div>
    </div>
    <div class="countdown__block">
      <div class="countdown__digit font-weight-light">{{ minutes | twoDigits }}</div>
      <div class="countdown__text">Min</div>
    </div>
    <div class="countdown__block">
      <div class="countdown__digit font-weight-light">{{ seconds | twoDigits }}</div>
